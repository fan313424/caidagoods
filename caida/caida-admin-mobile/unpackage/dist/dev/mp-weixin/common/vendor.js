...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"财大优选管理端","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 31 */
/*!****************************************************!*\
  !*** D:/itfan/caida/caida-admin-mobile/pages.json ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 40 */
/*!*********************************************************!*\
  !*** D:/itfan/caida/caida-admin-mobile/utils/config.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var ADMIN_INFO_KEY = 'admin_info';

// 请求封装
var request = function request(options) {
  return new Promise(function (resolve, reject) {
    var token = uni.getStorageSync(ADMIN_TOKEN_KEY);
    uni.request({
...
var checkLogin = function checkLogin() {
  var token = uni.getStorageSync(ADMIN_TOKEN_KEY);
  var adminInfo = uni.getStorageSync(ADMIN_INFO_KEY);
