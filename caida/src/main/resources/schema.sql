...
-- 插入示例用户数据（使用 IGNORE 防止重复）
INSERT IGNORE INTO user (username, password, nickname, email, phone, role, status) VALUES
('admin', '123456', '超级管理员', 'admin@caida.edu.cn', '13800138000', 1, 1),
('test', '123456', '测试用户', 'test@caida.edu.cn', '13800138001', 0, 1);

-- 插入示例员工数据
INSERT IGNORE INTO employee (employee_no, name, password, department, position, email, phone, status) VALUES
('EMP001', '张三', '123456', '技术部', '软件工程师', 'zhangsan@caida.edu.cn', '13900139001', 1),
('EMP002', '李四', '123456', '市场部', '市场专员', 'lisi@caida.edu.cn', '13900139002', 1);

-- 插入示例超级管理员数据
INSERT IGNORE INTO admin (username, password, real_name, role, email, phone, status) VALUES
('superadmin', 'admin123', '系统管理员', 1, 'superadmin@caida.edu.cn', '13900139000', 1);

-- 插入示例商品数据
INSERT IGNORE INTO product (name, description, price, image_url, category, stock, status) VALUES
...
('校园双肩包', '简约时尚大容量，防水耐磨，上课出行必备', 259.00, 'images/goods07.png', '服装配饰', 70, 1),
('智能平板电脑', '轻薄便携、护眼大屏，学习网课娱乐三合一', 3299.00, 'images/goods09.png', '手机数码', 25, 1);
